  ...
  return (
    ...
    <div className="md:w-2/3 mx-auto w-full pb-16 sm:max-w-screen-sm md:max-w-screen-md lg:w-1/3 lg:max-w-screen-lg xl:max-w-screen-xl">
      <form className="shadow-lg mb-4 rounded-lg border border-gray-100 py-10 px-8">
        <div className="mb-4"><label className="mb-2 block text-sm font-bold" for="email">E-mail</label><input className="shadow-sm w-full cursor-text appearance-none rounded border border-gray-300 py-2 px-3 leading-tight outline-none ring-blue-500 focus:ring" id="email" type="email" placeholder="Email" required="" /><span className="my-2 block"></span></div>
        
        {
            type === 'Register' && (
                <div className="mb-4"><label className="mb-2 block text-sm font-bold" for="phone">Username</label><input className="shadow-sm w-full cursor-text appearance-none rounded border border-gray-300 py-2 px-3 leading-tight outline-none ring-blue-500 focus:ring" id="username" type="username" placeholder="Username" required="" /><span className="my-2 block"></span></div>
            )
        }

        <div className="mb-4"><label className="mb-2 block text-sm font-bold" for="password">Password</label><input className="shadow-sm w-full cursor-text appearance-none rounded border border-gray-300 py-2 px-3 leading-tight outline-none ring-blue-500 focus:ring" id="password" type="password" placeholder="******************" required="" /></div>
       
       {
       type==='Register' && ( <div className="mb-6">
