        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-center space-x-5">
            ...
            <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
              <h2 className="leading-relaxed">{type} Post</h2>
          ...
          <div className="divide-y divide-gray-200">
            <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div className="flex flex-col">
                <label className="leading-loose">Slug</label>
              ...
              <div className="flex flex-col">
                ...
                <input type="text" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Optional"/>           </div>
            </div>
